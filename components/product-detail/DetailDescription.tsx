  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.statsContainer, { borderColor: colors.border }]}>
        ...
        <View style={styles.flexGap}>
          <AntDesign name="star" size={24} color="orange" />
          <AppText weight="medium" size={15} color={colors.text}>
            {rating}
          </AppText>
        </View>

        <AppText color={colors.textFaint}>|</AppText>
      ...
      <View style={styles.productNameContainer}>
        ...
        >
          ...
          <AppText size={20} weight="semibold" color={colors.text}>
            {quantity}
          </AppText>
      ...
      {/* Product desc */}
      <View style={styles.descriptionContainer}>
        <AppText style={styles.description} color={colors.textMuted} size={16}>
          {description}
        </AppText>
      </View>
      ...
      {/* Product price and add to cart */}
      <View style={styles.addToCartContainer}>
        <AppText size={26} weight="bold" color={colors.text}>
          ${(price * quantity).toFixed(2)}
        </AppText>
