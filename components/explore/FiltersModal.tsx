    ...
    >
      <View style={styles.backdrop}>
        <SafeAreaView style={[styles.sheet, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.chipRow}>
            {sortOptions.map((option) => {
              const isActive = selectedSort.includes(option);
              return (
                <TouchableOpacity
                  key={option}
                  onPress={() => toggleSort(option)}
          ...
          <View style={[styles.othersRow, { backgroundColor: colors.surface }]}>
          ...
          <View style={styles.footer}>
            <TouchableOpacity
              onPress={handleRemoveAll}
              style={[styles.removeAllButton, { borderColor: colors.border }]}
            >
